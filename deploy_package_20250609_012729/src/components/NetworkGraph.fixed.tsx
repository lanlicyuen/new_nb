// 网络化思考图谱组件（Network Graph View）- 修复版本
 ...
 */
const NetworkGraph: React.FC<NetworkGraphProps> = ({ data, onNodeClick, className }) => {
  ...
  useEffect(() => {
    ...
    nodeGroup.append("text")
      ...
      .attr("font-size", d => Math.max((d.size || 20) * 0.5, 10))
      .attr("fill", "#ffffff")
      .text(d => {
        switch(d.type) {
    ...
    .append("circle")
      .attr("r", 8)
      .attr("cx", d => (d.size || 20) - 2)
      .attr("cy", d => -((d.size || 20) - 2))
      .attr("fill", "#ff0000")
      .attr("stroke", "#ffffff")
